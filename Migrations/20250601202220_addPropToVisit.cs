...
{
    /// <inheritdoc />
    public partial class addPropToVisit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SurgicalHistories = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FamilyHistories = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Allergies = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocialHistories = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HistoryOfPresentIllness = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RequiredInvestigations = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrugHistorys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DrugHistorys_MedicalHistorys_MedicalHistoryId",
                        column: x => x.MedicalHistoryId,
                        principalTable: "MedicalHistorys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DrugHistorys_Medicines_medicineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DrugHistorys_MedicalHistoryId",
                table: "DrugHistorys",
                column: "MedicalHistoryId");

            migrationBuilder.CreateIndex(
                name: "IX_DrugHistorys_medicineId",
                table: "DrugHistorys",
                column: "medicineId");
